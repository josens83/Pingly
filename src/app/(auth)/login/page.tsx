...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-pingly-50 via-white to-violet-50 px-4 py-12">
      ...
      >
        <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="pt-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-sm text-pingly-600 hover:text-pingly-700 hover:underline"
                  >
                    비밀번호 찾기
                  </Link>
                </div>
            ...
            >
              계정이 없으신가요?{' '}
              <Link href="/register" className="text-pingly-600 font-medium hover:text-pingly-700 hover:underline">
                회원가입
              </Link>
            </motion.p>
          </CardContent>
